...
import { Search, RefreshCw, Loader2, Bookmark, BookmarkCheck, TrendingUp } from "lucide-react";
...
function CaseCard({ item, isSaved, onToggleSave, savingId }) {
...
export default function DiscoverCases() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white p-8 space-y-6">
      <div>
        <h1 className="text-2xl font-semibold">Discover Cases: Uncovering the Untold</h1>
